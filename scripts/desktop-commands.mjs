...
//  not found", which reads like anything except what it is. Verbatim from
//  lattice, where that omission shipped three separate times:
//
...
//
//  Nothing caught any of them, because a browser suite stubs or skips the
//  bridge and never invokes for real. So this checks the three lists agree:
//
